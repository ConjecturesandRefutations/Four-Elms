    ...
    <>
      <div className="text-gray-600" id="home">
        <div className="grid md:grid-cols-4">
          ...
          <main className="background px-7 md:px-10 lg:px-16 py-6 md:col-span-3" id="home-main">
            <header>
              <h2 className="text-gray-700 text-6xl font-semibold">Four Elms</h2>
            ...
            <div>
              ...
              <div className="mt-8 grid lg:grid-cols-3 gap-10">
                ...
                >
                  <img src={pic1} alt="Front View" className="w-full h-32 sm:h-48 object-cover" />
                  <div className="m-4">
                    <span className="font-bold">
                      {lang === 'english' ? 'Located in rural Surrey' : 'En Surrey rural'}
                    </span>
                  </div>
                </div>

                <div className="bg-white rounded overflow-hidden shadow-md relative hover:shadow-lg p-4">
                ...
                >
                  <img src={pic2} alt="Kitchen" className="w-full h-32 sm:h-48 object-cover" />
                  <div className="m-4">
                    <span className="font-bold">
                      {lang === 'english' ? 'Traditional Kitchen' : 'Cocina Tradicional'}
                    </span>
                  </div>
                </div>
                ...
                >
                  <img src={pic4} alt="Garden" className="w-full h-32 sm:h-48 object-cover" />
                  <div className="m-4">
                    <span className="font-bold">
                      {lang === 'english' ? 'Award-winning Garden' : 'Jardín premiado'}
                    </span>
                  </div>
                </div>
                ...
                >
                  <img src={pic3} alt="Conservatory" className="w-full h-32 sm:h-48 object-cover" />
                  <div className="m-4">
                    <span className="font-bold">
                      {lang === 'english' ? 'Beautiful Conservatory' : 'Hermoso Conservatorio'}
                    </span>
                  </div>
                </div>
                ...
                >
                  <img src={pic5} alt="Decorated Room" className="w-full h-32 sm:h-48 object-cover" />
                  <div className="m-4">
                    <span className="font-bold">
                      {lang === 'english' ? 'Tastefully Decorated' : 'Decorado con buen gusto'}
                    </span>
                  </div>
                </div>
              </div>
