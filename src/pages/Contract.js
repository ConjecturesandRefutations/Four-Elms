...
<p class='mb-8'>{lang==='english' ? `The front room, under-stairs cupboards and garden shed are not included as part of this agreement and will be kept locked. The Landlords and their representatives and relations reserve the right to access any part of the property, when necessary, and without good reason. The gardener and house cleaner (Thomas Filipeck) will require access to the garden for 11 hours a week.` : `La sala del frente, los armarios debajo de las escaleras y el cobertizo del jardín no están incluidos como parte de este acuerdo y se mantendrán cerrados con llave. Los Arrendadores y sus representantes y relaciones se reservan el derecho de acceder a cualquier parte de la propiedad, cuando sea necesario y sin motivo justificado. El jardinero y limpiador de la casa (Thomas Filipeck ) requerirá acceso al jardín durante 11 horas a la semana.`}</p>
