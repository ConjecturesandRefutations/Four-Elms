...
import SpanishHotPlaces from '../../images/Aga/SpanishHotPlates.png'
import SpanishOvens from '../../images/Aga/SpanishOvens.png'
import SpanishInserts from '../../images/Aga/Spanish AGA Inserts.png'
import SpanishToast from '../../images/Aga/Spanish Toast.png'
...
<h1 class='text-2xl font-bold mb-8 mt-4' id='aga'> {lang==='english' ? 'THE SECRET OF AGA COOKING — HOW YOUR AGA COOKER WORKS' : 'EL SECRETO DE LA COCINA AGA: CÓMO FUNCIONA SU COCINA AGA'} </h1>
...
<div class="bg-white rounded overflow-hidden shadow-md relative hover:shadow-lg">
    {lang === 'english' ? <img src={Aga1} alt="aga plates" class="w-full h-full sm:h-full object-cover"/> : <img src={SpanishHotPlaces} alt="aga plates spanish" class="w-full h-full sm:h-full object-cover"/>}
...
<h2 class='text-l font-bold mb-6 mt-8'>{lang==='english' ? `BAKING OVEN` : `HORNO DE HORNEAR`}</h2>
...
{lang==='english' ? <img src={Aga3} alt='aga equiptment' /> : <img src={SpanishInserts} alt='aga equiptment' />}

<br/>
{lang==='english' ? <img src={Aga4} alt='more aga equiptment' /> : <img src={SpanishToast} alt='more aga equiptment' />}
...
<h3 class='font-bold mb-3'>Traducción de vídeo</h3>
